  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <Link
        ...
        className="rounded-[20px] h-[170px] sm:h-[200px] overflow-hidden relative cursor-pointer group hover:scale-[1.01] transition-transform bg-gradient-to-r from-[#b8651a] via-[#b8651a]/80 to-[#d99248]/70 block"
      >
      ...
      >
        <div className="absolute left-5 right-5 sm:left-8 sm:right-8 top-1/2 -translate-y-1/2">
          ...
          <span className="inline-block bg-[#b8651a] text-white px-4 sm:px-6 py-2 sm:py-2.5 rounded-[10px] font-bold text-[12px] sm:text-[13px] mt-2 sm:mt-3 group-hover:bg-[#934f12] transition-colors">
            Hemen Keşfet
          </span>
        </div>
      </Link>
