...
function RecommendedContent() {
    ...
    const applyFilters = (newFilters: Filters) => {
        ...
        router.push(`/market/onerilen${queryString ? `?${queryString}` : ''}`, { scroll: false });
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            ...
            <div className="flex items-center gap-2 text-sm text-slate-500 dark:text-slate-400 mb-6">
                ...
                <span className="text-slate-900 dark:text-white font-medium">Sizin İçin Önerilen</span>
            </div>

            {/* Header */}
            <div className="bg-gradient-to-r from-cyan-500 to-cyan-600 rounded-lg p-6 mb-6">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-white/80 mt-1">
                                Size özel seçilmiş ürünler - {totalProducts} ürün
                            </p>
                        </div>
                    </div>
                    <Button
            ...
            <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-2">
                    <Sparkles className="w-5 h-5 text-accent-soft0" />
                    <span className="text-slate-600 dark:text-slate-400">Her yenilemede farklı ürünler</span>
                </div>
