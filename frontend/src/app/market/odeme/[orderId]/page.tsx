...
export default function PaymentPage() {
            ...
            <div className="fixed inset-0 z-50 bg-white dark:bg-slate-950">
                <div className="flex items-center justify-between px-4 py-3 border-b border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950">
                    <div className="flex items-center gap-2 text-sm text-slate-600 dark:text-slate-400">
                        <Shield className="h-4 w-4 text-[#b8651a]" />
    ...
    if (pageState === 'error') {
        return (
            <div className="max-w-2xl mx-auto px-4 py-8">
                <Button variant="ghost" asChild className="gap-2 text-slate-600 dark:text-slate-400 hover:text-[#b8651a] -ml-4 mb-6">
                    <Link href="/market">
                    ...
                    <CardContent className="pt-6">
                        <div className="text-center py-8">
                            ...
                            <div className="flex items-center justify-center gap-3">
                                <Button onClick={initializePayment} className="gap-2 bg-[#b8651a] hover:bg-[#934f12]">
                ...
                <div className="mb-4 p-4 bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-200 dark:border-slate-700">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            <div className="w-10 h-10 bg-[#b8651a]/10 rounded-lg flex items-center justify-center">
                                <CreditCard className="h-5 w-5 text-[#b8651a]" />
                            </div>
                            <div>
                        ...
                        <div className="text-right">
                            ...
                            <p className="text-lg font-bold text-[#b8651a]">
