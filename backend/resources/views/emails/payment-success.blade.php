...
<head>
    ...
    <title>Ödeme Onaylandı — i-kirtasiye</title>
    <style>
...
<body style="margin:0;padding:0;background-color:#f0fdfa;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;">
    <div style="display:none;font-size:1px;color:#f0fdfa;line-height:1px;max-height:0;max-width:0;opacity:0;overflow:hidden;">
        Ödemeniz başarıyla tamamlandı. Sipariş #{{ $order->order_number }} hazırlanıyor.
    </div>
                ...
                <table role="presentation" cellpadding="0" cellspacing="0" width="600" style="max-width:600px;width:100%;">
                    ...
                    <tr>
                        <td align="center" style="background:linear-gradient(135deg,#0390b1,#027a96);padding:40px 40px 32px;border-radius:16px 16px 0 0;">
                            ...
                            <p style="margin:0;font-size:14px;color:rgba(255,255,255,0.85);font-weight:400;">Ödemeniz başarıyla tamamlandı!</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="background:#ffffff;padding:40px;border-left:1px solid #e5e7eb;border-right:1px solid #e5e7eb;">
                            ...
                            <table role="presentation" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td align="center" style="padding-bottom:24px;">
                                        <div style="width:72px;height:72px;border-radius:50%;background:#ecfdf5;border:3px solid #059669;display:inline-block;line-height:72px;text-align:center;font-size:36px;color:#059669;">
                                            &#10003;
                                        </div>
                                    </td>
                                </tr>
                            ...
                            <p style="margin:0 0 28px;font-size:15px;line-height:1.7;color:#6b7280;">
                                Siparişiniz için ödeme başarıyla alınmıştır. Siparişiniz satıcılar tarafından hazırlanmaya başlanıyor.
                            </p>
                                ...
                                <tr>
                                    <td style="background:#ecfdf5;border:1px solid #a7f3d0;border-radius:12px;padding:20px 24px;">
                                        <table role="presentation" cellpadding="0" cellspacing="0" width="100%">
                                            ...
                                            <tr>
                                                <td style="padding:6px 0;font-size:14px;color:#6b7280;">Ödeme Durumu:</td>
                                                <td style="padding:6px 0;text-align:right;">
                                                    <span style="display:inline-block;background:#059669;color:#ffffff;padding:4px 14px;border-radius:20px;font-size:12px;font-weight:700;">Ödendi</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="2" style="border-top:1px solid #6ee7b7;padding-top:10px;"></td>
                                            </tr>
                                            <tr>
                                                <td style="padding:6px 0;font-size:16px;font-weight:700;color:#1a1a1a;">Ödenen Tutar:</td>
                                                <td style="padding:6px 0;font-size:18px;font-weight:800;color:#059669;text-align:right;">{{ number_format($order->total_amount, 2, ',', '.') }} &#8378;</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                            ...
                            <p style="margin:0;font-size:14px;line-height:1.6;color:#9ca3af;text-align:center;">
                                Siparişinizin kargoya verilmesi durumunda ayrıca bilgilendirileceksiniz.
                            </p>
