...
<head>
    ...
    <title>Siparişiniz Kargoya Verildi — i-kirtasiye</title>
    <style>
...
<body style="margin:0;padding:0;background-color:#f0fdfa;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;">
    <div style="display:none;font-size:1px;color:#f0fdfa;line-height:1px;max-height:0;max-width:0;opacity:0;overflow:hidden;">
        Siparişiniz {{ $sellerName }} tarafından kargoya verildi. Takip numaranız hazır.
    </div>
                ...
                <table role="presentation" cellpadding="0" cellspacing="0" width="600" style="max-width:600px;width:100%;">
                    ...
                    <tr>
                        <td align="center" style="background:linear-gradient(135deg,#0390b1,#027a96);padding:40px 40px 32px;border-radius:16px 16px 0 0;">
                            ...
                            <p style="margin:0;font-size:14px;color:rgba(255,255,255,0.85);font-weight:400;">Siparişiniz kargoya verildi!</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="background:#ffffff;padding:40px;border-left:1px solid #e5e7eb;border-right:1px solid #e5e7eb;">
                            ...
                            <p style="margin:0 0 28px;font-size:15px;line-height:1.7;color:#6b7280;">
                                Siparişinizin bir bölümü <strong style="color:#1a1a1a;">{{ $sellerName }}</strong> tarafından kargoya verildi.
                            </p>
                                ...
                                <tr>
                                    <td style="background:#ecfeff;border:1px solid #67e8f9;border-radius:12px;padding:20px 24px;">
                                        <table role="presentation" cellpadding="0" cellspacing="0" width="100%">
                                            ...
                                            <tr>
                                                <td style="padding:6px 0;font-size:14px;color:#6b7280;">Satıcı:</td>
                                                <td style="padding:6px 0;font-size:14px;font-weight:600;color:#1a1a1a;text-align:right;">{{ $sellerName }}</td>
                                            </tr>
                                            @if($subOrder->shipping_provider)
                                            <tr>
                                                <td style="padding:6px 0;font-size:14px;color:#6b7280;">Kargo Firması:</td>
                                                <td style="padding:6px 0;font-size:14px;font-weight:600;color:#1a1a1a;text-align:right;">{{ $subOrder->shipping_provider }}</td>
                                            </tr>
                                            @endif
                                            ...
                                            <tr>
                                                <td style="padding:6px 0;font-size:14px;color:#6b7280;">Takip No:</td>
                                                <td style="padding:6px 0;font-size:16px;font-weight:800;color:#0390b1;text-align:right;letter-spacing:1px;">{{ $subOrder->tracking_number }}</td>
                                            </tr>
                                            @endif
                                            <tr>
                                                <td style="padding:6px 0;font-size:14px;color:#6b7280;">Kargo Tarihi:</td>
                                                <td style="padding:6px 0;font-size:14px;font-weight:600;color:#1a1a1a;text-align:right;">{{ $subOrder->shipped_at ? $subOrder->shipped_at->format('d.m.Y H:i') : now()->format('d.m.Y H:i') }}</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                            ...
                            <h3 style="margin:0 0 16px;font-size:16px;font-weight:700;color:#1a1a1a;">Kargodaki Ürünler</h3>
                            ...
                            <p style="margin:0;font-size:14px;line-height:1.6;color:#9ca3af;text-align:center;">
                                Teslimat sonrası siparişinizi onaylamayı unutmayınız.
                            </p>
